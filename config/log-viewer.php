...
// Note: Les enums ne sont pas disponibles dans toutes les versions du package
// Utilisation de valeurs string à la place
...
return [
    ...
    */
    ...
    'back_to_system_url' => '/Administrateur/dashboard',

    'back_to_system_label' => 'Retour au tableau de bord', // Displayed by default: "Back to {{ app.name }}"
